...
export class TyfcbService {
  ...
  async createTyfcb(tyfcbData: CreateTyfcbRequest): Promise<TyfcbResponse> {
    try {
      ...
      await swalHelper.showToast(response.message || 'TYFCB created successfully', 'success');
  ...
  async getTyfcbById(tyfcbId: string): Promise<TyfcbResponse> {
    try {
      ...
      await swalHelper.showToast(response.message || 'TYFCB fetched successfully', 'success');
      return response.data || response;
    } catch (error: any) {
  ...
  async getTyfcbsByGiverId(page: number = 1, limit: number = 10): Promise<TyfcbResponse> {
    try {
      ...
      await swalHelper.showToast(response.message || 'Given TYFCBs fetched successfully', 'success');
      return response.data || response;
    } catch (error: any) {
  ...
  async getTyfcbsByReceiverId(page: number = 1, limit: number = 10): Promise<TyfcbResponse> {
    try {
      ...
      await swalHelper.showToast(response.message || 'Received TYFCBs fetched successfully', 'success');
      return response.data || response;
    } catch (error: any) {
